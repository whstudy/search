...
const swaggerUrl = `http://10.128.134.127:8000/swagger/dsm-swagger/-/raw/${`object-retrieval-v4.2`||process.argv[2]||branchName}/main.yaml`
...
try {
  const stdout = execSync(`swagger-cli bundle -o doc/swagger.yaml -t yaml ${swaggerUrl}`).toString().trim();
  console.log(`执行成功`, stdout)
} catch (e) {
  console.log(`执行失败`)
  return;
